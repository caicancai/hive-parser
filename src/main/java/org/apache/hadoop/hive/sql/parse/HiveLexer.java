// $ANTLR 3.4 HiveLexer.g 2024-07-26 12:53:35
...
public class HiveLexer extends GenericHiveLexer {
    ...
    public HiveLexer(CharStream input, RecognizerSharedState state) {
        super(input,state);
        gHiveLexerParent = new HiveLexer_HiveLexerParent(input, state, this);
    }
    ...
    public void mTokens() throws RecognitionException {
        // HiveLexer.g:1:8: ( StringLiteral | HiveLexerParent. Tokens )
        int alt5=2;
        alt5 = dfa5.predict(input);
        switch (alt5) {
            case 1 :
                // HiveLexer.g:1:10: StringLiteral
                {
                mStringLiteral(); 
                ...
                break;
            case 2 :
                // HiveLexer.g:1:24: HiveLexerParent. Tokens
                {
    ...
    static final String DFA5_minS =
        "\1\11\2\0\1\uffff\2\0\1\42\2\0\1\42\1\0\1\uffff\1\0";
    static final String DFA5_maxS =
        "\1\176\2\uffff\1\uffff\2\uffff\1\47\2\uffff\1\47\1\uffff\1\uffff"+
        "\1\uffff";
    static final String DFA5_acceptS =
        "\3\uffff\1\2\7\uffff\1\1\1\uffff";
    static final String DFA5_specialS =
        "\1\uffff\1\4\1\6\1\uffff\1\5\1\2\1\uffff\1\0\1\1\1\uffff\1\7\1\uffff"+
        "\1\3}>";
    static final String[] DFA5_transitionS = {
            "\2\3\2\uffff\1\3\22\uffff\2\3\1\1\1\uffff\3\3\1\2\30\3\1\uffff"+
            "\33\3\1\uffff\42\3",
            "\42\4\1\6\71\4\1\5\uffa3\4",
            "\47\7\1\11\64\7\1\10\uffa3\7",
            "",
            "\42\4\1\6\71\4\1\5\uffa3\4",
            "\0\12",
            "\1\1\4\uffff\1\2",
        ...
        public int specialStateTransition(int s, IntStream _input) throws NoViableAltException {
            ...
            switch ( s ) {
                    case 0 : 
                        ...
                        else if ( ((LA5_7 >= '\u0000' && LA5_7 <= '&')||(LA5_7 >= '(' && LA5_7 <= '[')||(LA5_7 >= ']' && LA5_7 <= '\uFFFF')) ) {s = 7;}
                    ...
                    case 3 : 
                        ...
                        else if ( ((LA5_12 >= '\u0000' && LA5_12 <= '&')||(LA5_12 >= '(' && LA5_12 <= '[')||(LA5_12 >= ']' && LA5_12 <= '\uFFFF')) ) {s = 7;}
                    ...
                    case 4 : 
                        ...
                        s = -1;
                        if ( ((LA5_1 >= '\u0000' && LA5_1 <= '!')||(LA5_1 >= '#' && LA5_1 <= '[')||(LA5_1 >= ']' && LA5_1 <= '\uFFFF')) ) {s = 4;}
                    ...
                    case 5 : 
                        ...
                        else if ( ((LA5_4 >= '\u0000' && LA5_4 <= '!')||(LA5_4 >= '#' && LA5_4 <= '[')||(LA5_4 >= ']' && LA5_4 <= '\uFFFF')) ) {s = 4;}
                    ...
                    case 6 : 
                        ...
                        s = -1;
                        if ( ((LA5_2 >= '\u0000' && LA5_2 <= '&')||(LA5_2 >= '(' && LA5_2 <= '[')||(LA5_2 >= ']' && LA5_2 <= '\uFFFF')) ) {s = 7;}
                    ...
                    case 7 : 
                        ...
                        else if ( ((LA5_10 >= '\u0000' && LA5_10 <= '!')||(LA5_10 >= '#' && LA5_10 <= '[')||(LA5_10 >= ']' && LA5_10 <= '\uFFFF')) ) {s = 4;}
