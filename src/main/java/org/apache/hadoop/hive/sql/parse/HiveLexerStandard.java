// $ANTLR 3.4 HiveLexerStandard.g 2024-07-26 12:54:16
...
public class HiveLexerStandard extends GenericHiveLexer {
    ...
    // delegates
    public HiveLexerStandard_HiveLexerParent gHiveLexerParent;
    // delegators
    public GenericHiveLexer[] getDelegates() {
        return new GenericHiveLexer[] {gHiveLexerParent};
    }

    public HiveLexerStandard() {} 
    public HiveLexerStandard(CharStream input) {
        this(input, new RecognizerSharedState());
    }
    public HiveLexerStandard(CharStream input, RecognizerSharedState state) {
        super(input,state);
        gHiveLexerParent = new HiveLexerStandard_HiveLexerParent(input, state, this);
    }
    public String getGrammarFileName() { return "HiveLexerStandard.g"; }
    ...
    public final void mStringLiteral() throws RecognitionException {
        try {
            ...
            // HiveLexerStandard.g:31:5: ( ( '\\'' (~ ( '\\'' | '\\\\' ) | ( '\\\\' . ) )* '\\'' )+ )
            // HiveLexerStandard.g:32:5: ( '\\'' (~ ( '\\'' | '\\\\' ) | ( '\\\\' . ) )* '\\'' )+
            {
            // HiveLexerStandard.g:32:5: ( '\\'' (~ ( '\\'' | '\\\\' ) | ( '\\\\' . ) )* '\\'' )+
            int cnt2=0;
            loop2:
            do {
                ...
                switch (alt2) {
            	case 1 :
            	    // HiveLexerStandard.g:32:7: '\\'' (~ ( '\\'' | '\\\\' ) | ( '\\\\' . ) )* '\\''
            	    {
            	    match('\''); 

            	    // HiveLexerStandard.g:32:12: (~ ( '\\'' | '\\\\' ) | ( '\\\\' . ) )*
            	    loop1:
            	    do {
            	        int alt1=3;
            	    	...
            	    	case 1 :
            	    	    ...
            	    	    break;
            	    	case 2 :
            	    	    // HiveLexerStandard.g:32:29: ( '\\\\' . )
            	    	    {
            	    	    // HiveLexerStandard.g:32:29: ( '\\\\' . )
            	    	    // HiveLexerStandard.g:32:30: '\\\\' .
            	    	    {
            	    	    match('\\'); 
    ...
    public final void mQuotedIdentifier() throws RecognitionException {
        try {
            ...
            switch (alt5) {
                case 1 :
                    // HiveLexerStandard.g:38:5: ( '\"' ( '\"\"' |~ ( '\"' ) )+ '\"' )
                    {
                    // HiveLexerStandard.g:38:5: ( '\"' ( '\"\"' |~ ( '\"' ) )+ '\"' )
                    // HiveLexerStandard.g:38:6: '\"' ( '\"\"' |~ ( '\"' ) )+ '\"'
                    {
                    match('\"'); 

                    // HiveLexerStandard.g:38:11: ( '\"\"' |~ ( '\"' ) )+
                    int cnt3=0;
                    loop3:
                    do {
                        int alt3=3;
                    ...
                    break;
                case 2 :
                    // HiveLexerStandard.g:39:7: ( '`' ( '``' |~ ( '`' ) )+ '`' )
                    {
                    // HiveLexerStandard.g:39:7: ( '`' ( '``' |~ ( '`' ) )+ '`' )
                    // HiveLexerStandard.g:39:8: '`' ( '``' |~ ( '`' ) )+ '`'
                    {
                    match('`'); 

                    // HiveLexerStandard.g:39:13: ( '``' |~ ( '`' ) )+
                    int cnt4=0;
                    loop4:
                    do {
                        int alt4=3;
    ...
    public void mTokens() throws RecognitionException {
        // HiveLexerStandard.g:1:8: ( StringLiteral | HiveLexerParent. Tokens )
        int alt6=2;
        alt6 = dfa6.predict(input);
        switch (alt6) {
            case 1 :
                // HiveLexerStandard.g:1:10: StringLiteral
                {
                mStringLiteral(); 
                ...
                break;
            case 2 :
                // HiveLexerStandard.g:1:24: HiveLexerParent. Tokens
                {
                gHiveLexerParent.mTokens(); 
    ...
    static final String DFA6_minS =
        "\1\11\1\0\1\uffff\2\0\1\47\1\0\1\uffff";
    static final String DFA6_maxS =
        "\1\176\1\uffff\1\uffff\2\uffff\1\47\1\uffff\1\uffff";
    static final String DFA6_acceptS =
        "\2\uffff\1\2\4\uffff\1\1";
    static final String DFA6_specialS =
        "\1\uffff\1\2\1\uffff\1\0\1\1\1\uffff\1\3\1\uffff}>";
    static final String[] DFA6_transitionS = {
            "\2\2\2\uffff\1\2\22\uffff\3\2\1\uffff\3\2\1\1\30\2\1\uffff\33"+
            "\2\1\uffff\42\2",
            "\47\3\1\5\64\3\1\4\uffa3\3",
            "",
            "\47\3\1\5\64\3\1\4\uffa3\3",
            "\0\6",
            "\1\1",
        ...
        public int specialStateTransition(int s, IntStream _input) throws NoViableAltException {
            ...
            switch ( s ) {
                    case 0 : 
                        ...
                        else if ( ((LA6_3 >= '\u0000' && LA6_3 <= '&')||(LA6_3 >= '(' && LA6_3 <= '[')||(LA6_3 >= ']' && LA6_3 <= '\uFFFF')) ) {s = 3;}
                    ...
                    case 2 : 
                        ...
                        s = -1;
                        if ( ((LA6_1 >= '\u0000' && LA6_1 <= '&')||(LA6_1 >= '(' && LA6_1 <= '[')||(LA6_1 >= ']' && LA6_1 <= '\uFFFF')) ) {s = 3;}
                    ...
                    case 3 : 
                        ...
                        else if ( ((LA6_6 >= '\u0000' && LA6_6 <= '&')||(LA6_6 >= '(' && LA6_6 <= '[')||(LA6_6 >= ']' && LA6_6 <= '\uFFFF')) ) {s = 3;}
